                ...
                <section id="datos_emergencia" class="demo ui-tabs ui-widget ui-widget-content ui-corner-all">
                    <fieldset>
                        <p>
                            ...
                            <label id="etq_calle" class="labels_socioeconomicos">Calle y No:</label>
                            ...
                            <input type="text" name="tel_fijo" id="tel_fijo" class="inputs_socioeconomicos" maxlength="12">
                            <label id="etq_telcel" class="labels_socioeconomicos">Teléfono Celular (LADA incluida):</label>
                            <input type="text" name="tel_cel" id="tel_cel" class="inputs_socioeconomicos" maxlength="13">                        
