c<%-- 
    Document   : datos_aspitante
    Created on : 5/07/2014, 02:22:37 AM
...
<html>
    <head>        
        ...
        <!--<link rel="stylesheet" href="Estilos/jquery.guillotine.css" type="text/css">-->
        ...
        <!--        <link rel="stylesheet" href="Estilos/PAES_css.css" media="all" type="text/css">
                <link rel="stylesheet" href="Estilos/jquery.guillotine.css" media="all" type="text/css">
                <link rel="stylesheet" href="Estilos/PAES_css.css" media="all" type="text/css">-->
        ...
        <!--<link href='Estilos/PAES_css.css' media='all' rel='stylesheet'  type="text/css">
        <!--<script src="JQueryClases/jquery.guillotine.js" type="text/javascript"></script>-->
        <!--<script src="JQueryClases/jquery.guillotine.min.js" type="text/javascript"></script>-->
        <!--<link href='Estilos/jquery.guillotine.css' media='all' rel='stylesheet' type="text/css">-->
        <!--<script src="JQueryClases/Zoom.js" type="text/javascript"></script>-->
