        ...
        <div id="carrera" class="demo ui-tabs ui-widget ui-corner-all tooltip-examples">
            <div id="pestana_carrera">
                ...
                <ul id="sangria">
                    ...
                    <!--<li><a href="http://www.snie.sep.gob.mx/SNIESC/" data-toggle="tooltip" data-original-title="Federal, Estatal, Privada" target="_blank">Clave de la escuela de procedencia</a></li>-->
                    <!--<li><a data-toggle="tooltip" data-original-title="Federal, Estatal, Privada" >Tipo de la escuela de procedencia</a></li>-->
